<script>
  ...
  const selectedPlan = plans.find(p => p.title === "Premium Support");
  let name = "";
  let email = "";
  let problem = "";
  let submitted = false;
  ...
  <div class="form-container">
    {#if !submitted}
      <div class="form">
        ...
        <h2>Book Your Premium Support Session</h2>
    ...
    {:else}
      <div class="success">
        ...
        <p>We'll be in touch shortly to confirm your Premium Support session.</p>
