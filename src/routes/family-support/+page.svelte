<script>
  ...
  const selectedPlan = plans.find(p => p.title === "Family Support");
  let name = "";
  let email = "";
  let problem = "";
  let submitted = false;
  ...
  <div class="form-container">
    {#if !submitted}
      <div class="form">
        ...
        <h2>Book Your Family Support Session</h2>
    ...
    {:else}
      <div class="success">
        ...
        <p>We'll be in touch shortly to confirm your Family Support session.</p>
